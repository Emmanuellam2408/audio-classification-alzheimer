...
file_path_3 = os.path.join(cwd, 'au_cla_alz_master', 'enhanced_training_groundtruth.csv')
file_path_4 = os.path.join(cwd, 'au_cla_alz_master', 'final_important_features_5_15_sec.csv')

#audios = "train"
mfcc = pd.read_csv("file_path_1")
text_features_labeled = pd.read_csv("file_path_2")
training_groundtruth = pd.read_csv("file_path_3")
important_features = pd.read_csv("file_path_4 ")
